...
import AbstractPageComponentTest from '../abstracts/AbstractPageComponentTest';
import DescribeBlock from '../common/DescribeBlock';
import ExpectTests from '../common/ExpectTests';
import TestDataHandler from '../common/TestDataHandler';
import {ID_PROP} from 'app/globals';
import {CustomElementSetFieldEvents} from '../includes/CustomElementTestFns';
...
class TestForm extends AbstractPageComponentTest {
    ...
    testEditForm() {
        ...
        var editUrl = ()=>{
            var id = that.id ? that.id : this.opts.fixture[ID_PROP];
