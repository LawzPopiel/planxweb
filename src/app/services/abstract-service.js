...
import ParserHelper from '../core/helpers/ParserHelper';
import {Inject} from '../ng-decorators'; // jshint unused: false

import {ID_PROP, API_BASE} from 'app/globals';

class AbstractService {
    constructor(http, route, $state, $rootScope, UserService) {
        this.http = http;
        this.route = route;
        this.$state = $state;
    ...
    create(newResource) {
        ...
        newResource.CreatedBy = this.UserService.getUsername();
        newResource.ModifiedBy = this.UserService.getUsername();
    ...
    update(updatedResource) {
        ...
        updatedResource.ModifiedBy = this.UserService.getUsername();
