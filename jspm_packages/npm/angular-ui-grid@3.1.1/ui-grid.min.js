  ...
  !function() {
            ...
            a.shown && a.$apply(function() {
              ...
              m = function(a) {
                ...
                if (9 === a.keyCode) {
                  var c,
                      e,
                      f = d[0].querySelectorAll("button:not(.ng-hide)");
          ...
          return {post: function(a, b, c, d) {
              ...
              function f() {
                if ("left" === a.side || "right" === a.side) {
                  for (var b = h.renderContainers[a.side].visibleColumnCache,
                      c = 0,
                      d = 0; d < b.length; d++) {
                    var e = b[d];
    ...
    angular.module("ui.grid").factory("Grid", ["$q", "$compile", "$parse", "gridUtil", "uiGridConstants", "GridOptions", "GridColumn", "GridRow", "GridApi", "rowSorter", "rowSearcher", "GridRenderContainer", "$timeout", "ScrollEvent", function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
      ...
      return p.prototype.calcFooterHeight = function() {
        ...
        for (e = 0; e < f.columns.length; e++)
          f.getColDef(f.columns[e].name) || (f.columns.splice(e, 1), e--);
        if (f.rowHeaderColumns.forEach(function(a) {
          ...
          for (e = 0; k > e; e++)
            f.columns[e + i].name !== f.options.columnDefs[e].name ? j[e + i] = f.getColumn(f.options.columnDefs[e].name) : j[e + i] = f.columns[e + i];
        ...
        if ("boolean" == typeof c ? d = c : f = c, d ? b.sort.priority || (b.sort.priority = e.getNextColumnSortPriority()) : (e.resetColumnSorting(b), b.sort.priority = void 0, b.sort.priority = e.getNextColumnSortPriority()), f)
          b.sort.direction = f;
        else {
        ...
        if (null !== c) {
          for (var r = g.indexOf(c),
              s = d.renderContainers.body.getCanvasWidth() - d.renderContainers.body.getViewportWidth(),
              t = 0,
              u = 0; r > u; u++) {
            var v = g[u];
            t += v.drawnWidth;
    ...
    angular.module("ui.grid").factory("GridRenderContainer", ["gridUtil", "uiGridConstants", function(a, b) {
      ...
      return c.prototype.reset = function() {
        ...
        for (var a = this,
            b = 0,
            c = 0,
            d = a.getViewportHeight(),
            e = a.visibleRowCache.length - 1; d > c && e >= 0; e--)
          c += a.visibleRowCache[e].height, b++;
        return b;
        ...
        for (var a = this,
            ...
            c = 0,
            d = 0,
            e = 0; e < a.visibleColumnCache.length; e++) {
          var f = a.visibleColumnCache[e];
          if (b > d)
            d += f.drawnWidth ? f.drawnWidth : 0, c++;
          else {
            for (var g = 0,
                h = e; h >= e - c; h--)
        ...
        for (var a = 0,
            b = 0; b < this.currentFirstColumn; b++)
    ...
    angular.module("ui.grid").factory("ScrollEvent", ["gridUtil", function(a) {
      ...
      return b.prototype.getNewScrollLeft = function(b, c) {
        ...
        if (!d.newScrollLeft) {
          var e,
              f = b.getCanvasWidth() - b.getViewportWidth(),
      ...
      var i = {
        ...
        rowTemplateAssigner: function(d) {
          ...
          if (d.rowTemplate) {
            ...
            d.rowTemplate = e.options.rowTemplate, d.getRowTemplateFn = e.getRowTemplateFn;
    ...
    b.service("rowSearcher", ["gridUtil", "uiGridConstants", function(b, c) {
      ...
      return e.getTerm = function(a) {
        ...
        var f,
            g = typeof e.condition,
            h = e.term;
        if (f = d.filterCellFiltered ? a.getCellDisplayValue(b, d) : a.getCellValue(b, d), e.condition instanceof RegExp)
    ...
    a.service("rowSorter", ["$parse", "uiGridConstants", function(a, b) {
      ...
      return d.guessSortFn = function(a) {
        ...
        if (c) {
          ...
          }), f = f.sort(d.prioritySort), 0 === f.length)
            return c;
          var g,
              h,
              i = function(a, b) {
    ...
    function b(a, b, c, d, e) {
      for (var f = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0,
          g = 0,
          h = ["Top", "Right", "Bottom", "Left"]; 4 > f; f += 2) {
        var i = h[f];
        if ("margin" === c) {
    ...
    function c(c, d, e) {
      ...
      if (0 >= f || null == f) {
        if (f = i[d], (0 > f || null == f) && (f = c.style[d]), g.test(f))
          return f;
    ...
    f.service("gridUtil", ["$log", "$window", "$document", "$http", "$templateCache", "$timeout", "$interval", "$injector", "$q", "$interpolate", "uiGridConstants", function(f, g, l, m, n, o, p, q, r, s, t) {
      ...
      var x = {
        ...
        nextUid: function() {
          for (var a,
              b = j.length; b; ) {
            if (b--, a = j[b].charCodeAt(0), 57 === a)
              return j[b] = "A", k + j.join("");
            if (90 !== a)
              return j[b] = String.fromCharCode(a + 1), k + j.join("");
            j[b] = "0";
          }
      ...
      x.focus = {
        ...
        byElement: function(a) {
          if (!angular.isElement(a))
            return x.logWarn("Trying to focus on an element that isn't an element."), r.reject("not-element");
        ...
        for (var d; null !== a; ) {
          if (d = a.parentElement, null !== d && d[c](b))
            return d;
          a = d;
        }
        return null;
        ...
        if ("undefined" != typeof a.length && a.length && (a = a[0]), c.isRTL())
          switch (x.rtlScrollType()) {
            case "default":
          ...
          var b = {
            ...
            methods: {cellNav: {
                ...
                rowColSelectIndex: function(b) {
                  for (var c = -1,
                      d = 0; d < a.cellNav.focusedCells.length; d++)
                ...
                b.prepend(e), a.$on(c.CELL_NAV_EVENT, function(a, b, c, d) {
                  ...
                  if (!d || "focus" !== d.type) {
                    for (var g = [],
                        ...
                        j = 0; j < i.length; j++)
                      g.push(i[j].getIntersectionValueFiltered());
                    var k = g.toString();
                    f(k);
                  }
                });
        ...
        link: function(b, l, m, n) {
          ...
          function v(h) {
            if (!E && t(b.col, b.row)) {
              ...
              if (n)
                j.when(n(b.row.entity, b.col.colDef)).then(function(a) {
          ...
          return {
            ...
            post: function(a, f, g, h) {
              ...
              h[0] && (i = h[0]), h[1] && (j = h[1]), h[2] && (k = h[2]), a.$on(c.events.BEGIN_CELL_EDIT, function(b, c) {
                if (d(function() {
                  if (f[0].focus(), f[0].select && a.col.colDef.enableCellEditOnFocus || !i || !i.grid.api.cellNav)
                    f[0].select();
                  else
                    try {
                ...
                if (!a.deepEdit || d.keyCode !== b.keymap.LEFT && d.keyCode !== b.keymap.RIGHT && d.keyCode !== b.keymap.UP && d.keyCode !== b.keymap.DOWN)
                  if (i && i.grid.api.cellNav)
                    d.uiGridTargetRenderContainerId = j.containerId, null !== i.cellNav.handleKeyDown(d) && a.stopEdit(d);
                  else
                    switch (d.keyCode) {
                      case b.keymap.ENTER:
                      case b.keymap.TAB:
          ...
          return {
            ...
            post: function(c, d, e, f) {
              ...
              c.$on(b.events.BEGIN_CELL_EDIT, function() {
                ...
                if (g && g.grid.api.cellNav)
                  d.uiGridTargetRenderContainerId = h.containerId, null !== g.cellNav.handleKeyDown(d) && c.stopEdit(d);
                else
                  switch (d.keyCode) {
                    case a.keymap.ENTER:
                    case a.keymap.TAB:
      ...
      var g = {
        ...
        downloadFile: function(a, b, c) {
          ...
          if (navigator.msSaveBlob)
            return navigator.msSaveOrOpenBlob(new Blob([c ? "\ufeff" : "", b], {type: h}), a);
          if ("download" in g) {
            var j = new Blob([c ? "\ufeff" : "", b], {type: h});
            d = URL.createObjectURL(j), g.setAttribute("download", a);
          } else
            d = "data:" + h + "," + encodeURIComponent(b), g.setAttribute("target", "_blank");
        ...
        downloadPDF: function(a, b) {
          ...
          c = this.isIE();
          var e,
              f = pdfMake.createPdf(b);
          f.getBuffer(function(b) {
            if (e = new Blob([b]), navigator.msSaveBlob)
    ...
    a.constant("uiGridGroupingConstants", {
      ...
      var j = {
        ...
        groupRows: function(a) {
          ...
          for (var c = j.initialiseProcessingState(b),
              e = function(e, h) {
        ...
        insertGroupHeader: function(a, b, c, d, g) {
          ...
          for (var l = function(a) {
            return angular.isObject(a) ? JSON.stringify(a) : a;
              ...
              m = a.grouping.oldGroupingHeaderCache,
              n = 0; g > n; n++)
            m && m[l(d[n].currentValue)] && (m = m[l(d[n].currentValue)].children);
          var o;
          for (m && m[l(i)] ? (o = m[l(i)].row, o.entity = {}) : (o = new e({}, null, a), f.rowTemplateAssigner.call(a, o)), o.entity["$$" + d[g].col.uid] = {groupVal: k}, o.treeLevel = g, o.groupHeader = !0, o.internalRow = !0, o.enableCellEdit = !1, o.enableSelection = a.options.enableGroupHeaderSelection, d[g].initialised = !0, d[g].currentValue = i, d[g].currentRow = o, j.finaliseProcessingState(d, g + 1), b.splice(c, 0, o), m = a.grouping.groupingHeaderCache, n = 0; g > n; n++)
        ...
        finaliseProcessingState: function(a, b) {
          for (var c = b; c < a.length; c++)
            a[c].initialised = !1, a[c].currentRow = null, a[c].currentValue = null;
        },
    ...
    a.constant("uiGridImporterConstants", {featureName: "importer"}), a.service("uiGridImporterService", ["$q", "uiGridConstants", "uiGridImporterConstants", "gridUtil", "$compile", "$interval", "i18nService", "$window", function(a, b, c, d, e, f, g, h) {
      var i = {
        initializeGrid: function(a, b) {
          ...
          var c = {
            events: {importer: {}},
            methods: {importer: {importFile: function(a) {
        ...
        registerPublicApi: function(a) {
          var b = this,
              c = {
                ...
                methods: {colMovable: {moveColumn: function(c, d) {
                      var e = a.columns;
          ...
          return {post: function(a, b, e, f) {
              if (a.col.colDef.enableColumnMoving) {
                var h,
                    ...
                    l,
                    m,
                    n = angular.element(b[0].querySelectorAll(".ui-grid-cell-contents")),
                    o = !1,
                    p = !1,
                    q = function(b) {
                    ...
                    s = function(b) {
                      if (document.onselectstart = null, l && (l.remove(), o = !1), u(), t(), p) {
                        for (var d = a.grid.columns,
                            e = 0,
                            f = 0; f < d.length && d[f].colDef.name !== a.col.colDef.name; f++)
                          e++;
                        var g;
                        if (0 > j) {
                          var h,
                ...
                var v = function() {
                  ...
                  e > d && (m = a.col.drawnWidth + (d - e), c.width = m + "px"), l.css(c);
                    ...
                    w = function(b) {
                      ...
                      var i,
                          n = l[0].getBoundingClientRect().left - 1,
                          o = l[0].getBoundingClientRect().right;
                      if (i = n - h + b, i = k > i ? i : k, (n >= h || b > 0) && (k >= o || 0 > b))
                        l.css({
                          visibility: "visible",
          ...
          var l = function() {
            e.showingLow = (j.paginationCurrentPage - 1) * j.paginationPageSize + 1, e.showingHigh = Math.min(j.paginationCurrentPage * j.paginationPageSize, j.totalItems);
              ...
              n = e.$watch("grid.options.paginationCurrentPage + grid.options.paginationPageSize", function(b, c) {
                if (b !== c && void 0 !== c) {
                  if (!angular.isNumber(j.paginationCurrentPage) || j.paginationCurrentPage < 1)
                    return void(j.paginationCurrentPage = 1);
                  if (j.totalItems > 0 && j.paginationCurrentPage > e.paginationApi.getTotalPages())
                    return void(j.paginationCurrentPage = e.paginationApi.getTotalPages());
    ...
    a.constant("uiGridPinningConstants", {container: {
        LEFT: "left",
        RIGHT: "right",
        NONE: ""
      ...
      var e = {
        initializeGrid: function(a) {
          ...
          var b = {
            ...
            methods: {pinning: {pinColumn: function(b, c) {
                  e.pinColumn(a, b, c);
                }}}
          };
          a.api.registerEventsFromObject(b.events), a.api.registerMethodsFromObject(b.methods);
        ...
        compile: function() {
          return {post: function(a, d, h, i) {
              ...
              if (j.options.enableColumnResizing) {
                ...
                var m = function() {
                  for (var b = d[0].getElementsByClassName("ui-grid-column-resizer"),
                      f = 0; f < b.length; f++)
    ...
    a.service("uiGridValidateService", ["$sce", "$q", "$http", "i18nService", "uiGridConstants", function(a, b, c, d, e) {
      var f = {
        ...
        initializeGrid: function(a, b) {
          ...
          var c = {
            events: {validate: {validationFailed: function(a, b, c, d) {}}},
            methods: {validate: {
