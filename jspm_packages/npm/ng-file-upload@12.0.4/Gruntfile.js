  ...
  module.exports = function(grunt) {
    ...
    grunt.initConfig({
      ...
      concat: {all: {
          ...
          files: {
            'dist/ng-file-upload.js': ['src/upload.js', 'src/model.js', 'src/select.js', 'src/data-url.js', 'src/validate.js', 'src/resize.js', 'src/drop.js', 'src/exif.js'],
      ...
      jshint: {
        ...
        all: ['Gruntfile.js', 'src/{,*/}*.js', '!src/FileAPI*.*', 'test/spec/{,*/}*.js']
      },
      replace: {version: {
    ...
    grunt.registerTask('default', ['jshint:all', 'clean:dist', 'concat:all', 'copy:fileapi', 'uglify', 'copy:build', 'copy:bower', 'replace:version']);
  };
})(require("process"));
