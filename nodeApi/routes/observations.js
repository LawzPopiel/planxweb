...
module.exports = (function() {
  ...
  router.post('/observations/observation-list', function(req, res, next) {
    var url_parts = url.parse(req.url, true);
    var query = url_parts.query;

    console.log('/observations/observation-list');

    request.get({
      url: host + '/v1/observations/observation-list?sub-asset-identifier=' + query['sub-asset-identifier'] ,
      headers: {
  ...
  router.get('/observations/observation-list', function(req, res, next) {
    var url_parts = url.parse(req.url, true);
    var query = url_parts.query;
    ...
    request.get({
      url: host + '/v1/observations/observation-list' ,
      headers: {
        'Authorization': 'Basic ' + new Buffer('powel398:pioneer#7').toString('base64'),
        'Content-Type': 'application/json;',
